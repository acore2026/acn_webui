...
WEBUI_PUBLIC_HOST="${WEBUI_PUBLIC_HOST:-101.245.78.174}"
MOQ_WEBTRANSPORT_HOST="${MOQ_WEBTRANSPORT_HOST:-101.245.78.174}"
MOQ_WEBTRANSPORT_PUBLIC_HOST="${MOQ_WEBTRANSPORT_PUBLIC_HOST:-101.245.78.174}"
export WEBUI_SCHEME
export WEBUI_PUBLIC_HOST
export MOQ_WEBTRANSPORT_HOST
export MOQ_WEBTRANSPORT_PUBLIC_HOST

    ...
    agents: [
      {
        ...
        trackSummary: "Mission video, Thermal +1",
        tracks: [
          { id: "mission-core-video", name: "Mission video", taskId: "task-core", namespace: "/task-core/mission-core", watchState: "subscribed", lastSeen: "2026-04-20T09:26:02.000000" },
          { id: "mission-core-thermal", name: "Thermal", taskId: "task-core", namespace: "/task-core/mission-core", watchState: "available", lastSeen: "2026-04-20T09:25:42.000000" },
          { id: "mission-core-camera", name: "Camera", taskId: "task-core", namespace: "/task-core/mission-core", watchState: "available", lastSeen: "2026-04-20T09:24:48.000000" }
        ],
        summary: "Primary coordination node responsible for task routing, policy sync, and mesh-wide scheduling.",
        uptime: "21d 04h",
        launchTime: "2026-03-30 05:20:00 UTC",
        offlineTime: "Unknown",
      ...
      },
      {
        ...
        status: "busy",
        region: "Harbor North",
        trackSummary: "Video, Thermal",
        tracks: [
          { id: "agent-alpha-video", name: "Video", taskId: "task-alpha", namespace: "/task-alpha/agent-alpha", watchState: "subscribed", lastSeen: "2026-04-20T09:25:55.000000" },
          { id: "agent-alpha-thermal", name: "Thermal", taskId: "task-alpha", namespace: "/task-alpha/agent-alpha", watchState: "available", lastSeen: "2026-04-20T09:25:10.000000" }
        ],
        summary: "Field recon agent focused on shoreline scans, target acquisition, and short-range video relay.",
        uptime: "08d 11h",
        launchTime: "2026-04-11 22:15:00 UTC",
        offlineTime: "Unknown",
      ...
      },
      {
        ...
        trackSummary: "Camera",
        tracks: [
          { id: "agent-beta-camera", name: "Camera", taskId: "task-beta", namespace: "/task-beta/agent-beta", watchState: "available", lastSeen: "2026-04-20T09:24:11.000000" }
        ],
        summary: "Response-focused node used for incident handling, route recovery, and operator escalation workflows.",
        uptime: "15d 02h",
        launchTime: "2026-04-05 07:00:00 UTC",
        offlineTime: "Unknown",
      ...
      },
      {
        ...
        uptime: "12d 18h",
        launchTime: "2026-04-07 14:30:00 UTC",
        offlineTime: "Unknown",
      ...
      },
      {
        ...
        trackSummary: "Video",
        tracks: [
          { id: "agent-delta-video", name: "Video", taskId: "task-delta", namespace: "/task-delta/agent-delta", watchState: "available", lastSeen: "2026-04-20T09:10:11.000000" }
        ],
        summary: "Spectrum observer assigned to radio health monitoring and interference analysis across the western band.",
        uptime: "Unavailable",
        launchTime: "2026-04-01 06:42:00 UTC",
        offlineTime: "2026-04-20 09:12:00 UTC",
      ...
      },
      {
        ...
        trackSummary: "Border feed, Camera",
        tracks: [
          { id: "agent-epsilon-border", name: "Border feed", taskId: "task-epsilon", namespace: "/task-epsilon/agent-epsilon", watchState: "subscribed", lastSeen: "2026-04-20T09:26:01.000000" },
          { id: "agent-epsilon-camera", name: "Camera", taskId: "task-epsilon", namespace: "/task-epsilon/agent-epsilon", watchState: "available", lastSeen: "2026-04-20T09:25:20.000000" }
        ],
        summary: "Routing guard node that validates border traffic, manages failover rules, and monitors route drift.",
        uptime: "17d 09h",
        launchTime: "2026-04-03 00:10:00 UTC",
        offlineTime: "Unknown",
        lastHeartbeat: "2s ago",
        taskCount: 41,
